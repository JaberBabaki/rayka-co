...
public class AdapterAnotherProduct extends ArrayAdapter<StrucItem> {

    public AdapterAnotherProduct(ArrayList<StrucItem> array) {
        super(G.context, R.layout.item_detils, array);
    ...
    private static class ViewHolder {
        ...
        public void fill(ArrayAdapter<StrucItem> adapter, final StrucItem item, int position) {
            ...
            imageLoader2.get(WebServiceUrl.getProductPicture + item.picFilm, ImageLoader.getImageListener(thumbPicPro, R.drawable.loading, R.drawable.no_teacher_pic));
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = G.inflater.inflate(R.layout.item_detils, parent, false);
